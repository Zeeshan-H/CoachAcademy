...
namespace Coach_Academy.Controllers
{
    ...
    public class usersController : ApiController
    {
        ...
        [Route("saving")]
        [HttpPost]
        public IHttpActionResult Saving() {

            string foldercreate = HttpContext.Current.Server.MapPath("~/SavedImages/");
            ...
            if(HttpContext.Current.Request.Files.AllKeys.Any()) {
                ...
                var fileupload = HttpContext.Current.Request.Files["photo"];

                if(fileupload != null) {

                    var savefiles = Path.Combine(HttpContext.Current.Server.MapPath("~/SavedImages/"), fileupload.FileName);
        ...
        [Route("upload2")]
        [HttpPost]
        public IHttpActionResult Upload2() {
            ...
            try
            {
                ...
                photo.SaveAs(HttpContext.Current.Server.MapPath("~/Uploads/" + photo.FileName));

                string z = "https://raw.githubusercontent.com/Zeeshan-H/CoachAcademy/master/Coach%20Academy/uploads/" + photo.FileName;
